...
[x] Phase 3: 玩家死亡与复活 (Week 5-7)
    ...
    [ ] P3.7: 更新 BattleEngine 结束条件 (玩家死亡时战斗继续，仅依赖现有逻辑)
    [x] P3.8: 配置复活时长 (已在 PlayerCombatant 中实现，默认 10 秒)
    [x] P3.9: UI 状态同步 (已更新 StepBattleStatusDto)
    [x] P3.10: 单元测试
